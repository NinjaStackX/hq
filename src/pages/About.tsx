            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="grid md:grid-cols-2 gap-6 mt-8">
                <div className="p-6 rounded-lg bg-primary/5">
                  ...
                  <p>أن نكون الوجهة الأولى للتسوق الإلكتروني في المنطقة، مع توفير أفضل تجربة تسوق لعملائنا.</p>
                </div>
                <div className="p-6 rounded-lg bg-secondary/5">
                  <h3 className="text-xl font-bold mb-3">رسالتنا</h3>
                  <p>تقديم منتجات عالية الجودة بأسعار تنافسية مع خدمة عملاء متميزة وتوصيل سريع.</p>
                </div>
              </div>
              ...
              <div className="mt-12">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    <span className="w-6 h-6 rounded-full bg-primary flex items-center justify-center text-primary-foreground text-sm mt-1">✓</span>
